...
export default function LayoutImageOnly({ banner }: { banner: SliderBanner }) {
        ...
        <div className="absolute inset-0 h-full w-full pointer-events-none">
          ...
          {media?.mobileImageUrl && (
            <Image
              ...
              alt={title || "Banner promocional móvil"}
              fill
  ...
  return (
    <Link
      ...
      className="relative block h-full w-full outline-none focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2"
