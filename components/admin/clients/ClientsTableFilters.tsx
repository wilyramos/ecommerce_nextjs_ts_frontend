            ...
            <td className="px-2 py-1">
                <div className="relative">
                    <input
                        ...
                        className="pl-8 py-2 border-b w-full text-sm focus:outline-none focus:border-black focus:border-b-3"
                     />
            ...
            <td className="px-2 py-1">
                <div className="relative">
                    <input
                        ...
                        value={filters.email}
                        onChange={handleChange}
                        className="pl-8 py-2 border-b w-full text-sm focus:outline-none focus:border-gray-800 focus:border-b-2"
                     />
                    <FiSearch className="absolute left-1.5 top-1/2 -translate-y-1/2 text-gray-400" />
                </div>
            </td>
