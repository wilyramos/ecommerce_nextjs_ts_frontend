      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="ring-offset-card focus:ring-ring data-[state=open]:bg-secondary data-[state=open]:text-secondary-foreground absolute top-4 right-4 rounded-full p-1 text-muted-foreground opacity-70 transition-all hover:opacity-100 hover:bg-secondary focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:pointer-events-none [&_svg]:size-4"
          >
            <XIcon />
