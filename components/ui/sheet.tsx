  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-surface-primary shadow-xl transition ease-in-out data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:animate-in data-[state=open]:duration-500",
          side === "right" &&
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="absolute top-4 right-4 rounded-radius-sm text-text-secondary opacity-70 ring-offset-surface-primary transition-opacity duration-fast hover:text-text-primary hover:opacity-100 focus:ring-2 focus:ring-brand-accent focus:ring-offset-2 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-surface-secondary">
