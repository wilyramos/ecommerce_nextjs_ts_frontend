        ...
        <main className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <section className="col-span-1 md:col-span-4 flex flex-col gap-2">
                    ...
                    <div className="flex justify-between md:justify-end items-center gap-2 text-sm py-2 border-b md:border-none sticky md:static top-11 bg-white md:bg-transparent z-10">
