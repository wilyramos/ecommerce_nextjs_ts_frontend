...
export default function PaymentNotice({ price, installments = 6 }: Props) {
    ...
    return (
        <div className="flex items-center justify-between gap-4 px-4 py-3.5 rounded-[var(--radius-md)] border border-border bg-card w-full">

            <div className="flex items-center gap-3 min-w-0">
                <div className="w-[34px] h-[34px] rounded-[var(--radius-md)] bg-gray-950 flex items-center justify-center shrink-0">
                ...
                <div>
                    <p className="text-[13px] font-medium text-foreground leading-snug">
                        Hasta {installments} cuotas sin intereses
                    </p>
